...
<details>
<summary><b>Optional advanced animations (adds 2 files in your profile repo)</b></summary>

If you want the animated contribution snake and a rotating 3D contributions render, you do not need to upload images. GitHub Actions will generate them.

### 1) Contribution Snake (auto-generated)
1. Create this file: `.github/workflows/snake.yml`
2. Paste this YAML:
  ...
  build:
    ...
    steps:
      - name: Generate snake
        uses: Platane/snk@v3
        with:
          github_user_name: RamiNoodle733
          outputs: |
            dist/snake.svg
